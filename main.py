...
def main():
    ...
    for key, pred in all_pred.items():
        ...
        print(eval.recall(prediction = pred, true_class = Yvalid, average= 'macro'))
        print('='*50)
    ...
    for key, pred in all_pred.items():
        portfolio = eval.portfolio_generator(principal = 10000.,prediction = pred, true_price = price,threshold = [0.70,0.801] ,leverage = 1.5 ,short = True)
